...
type Video struct {
	...
	//Alias        []Alias  `gorm:"alias" json:"alias"`                         //别名，片名
	...
	//Role         []Role   `gorm:"role" json:"role"`                           //主演
	...
	//Tags         []Tags   `gorm:"association_foreignkey:tags.id" json:"tags"` //标签
