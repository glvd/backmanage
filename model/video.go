...
type Video struct {
	...
	ThumbPath    string    `gorm:"cloumn:thumb_path" json:"thumb_path"`   //路径
	PosterHash   string    `gorm:"poster_hash" json:"poster_hash"`        //海报地址
	PosterPath   string    `gorm:"cloumn:poster_path" json:"poster_path"` //路径
	SourceHash   string    `gorm:"source_hash" json:"source_hash"`        //原片地址
	SourcePath   string    `gorm:"column:source_path" json:"source_path"` //路径
	M3U8Hash     string    `gorm:"column:m3u8_hash" json:"m3u8_hash"`     //切片地址
	M3u8Path     string    `gorm:"column:m3u8_path" json:"m3u8_path"`     //路径
