...
# Database: go_admin_demo
# Generation Time: 2019-09-19 14:01:36 +0000
# ************************************************************
...
INSERT INTO `adm_menu` (`id`, `parent_id`, `type`, `order`, `title`, `header`, `icon`, `uri`, `created_at`, `updated_at`)
VALUES
...
# Dump of table adm_operation_log
# ------------------------------------------------------------
...
LOCK TABLES `adm_operation_log` WRITE;
/*!40000 ALTER TABLE `adm_operation_log` DISABLE KEYS */;

INSERT INTO `adm_operation_log` (`id`, `user_id`, `path`, `method`, `ip`, `input`, `created_at`, `updated_at`)
VALUES
	(1,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-12 06:57:28','2019-09-12 06:57:28'),
	(2,1,'/admin/info/manager/new','GET','127.0.0.1','','2019-09-12 06:57:30','2019-09-12 06:57:30'),
	(3,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:13:53','2019-09-12 07:13:53'),
	(4,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"icon\":[\"fa-wpforms\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\",\"2\"],\"title\":[\"Form\"],\"uri\":[\"/form1\"]}','2019-09-12 07:14:19','2019-09-12 07:14:19'),
	(5,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"icon\":[\"fa-user\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\"],\"title\":[\"Users\"],\"uri\":[\"/info/user\"]}','2019-09-12 07:15:07','2019-09-12 07:15:07'),
	(6,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"icon\":[\"fa-users\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\"],\"title\":[\"Authors\"],\"uri\":[\"/info/authors\"]}','2019-09-12 07:16:04','2019-09-12 07:16:04'),
	(7,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"icon\":[\"fa-file-powerpoint-o\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\"],\"title\":[\"Posts\"],\"uri\":[\"/info/posts\"]}','2019-09-12 07:16:32','2019-09-12 07:16:32'),
	(8,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:35','2019-09-12 07:16:35'),
	(9,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:36','2019-09-12 07:16:36'),
	(10,1,'/admin/info/user','GET','127.0.0.1','','2019-09-12 07:16:37','2019-09-12 07:16:37'),
	(11,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:37','2019-09-12 07:16:37'),
	(12,1,'/admin/info/authors','GET','127.0.0.1','','2019-09-12 07:16:39','2019-09-12 07:16:39'),
	(13,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:39','2019-09-12 07:16:39'),
	(14,1,'/admin/info/posts','GET','127.0.0.1','','2019-09-12 07:16:40','2019-09-12 07:16:40'),
	(15,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:40','2019-09-12 07:16:40'),
	(16,1,'/admin/info/user','GET','127.0.0.1','','2019-09-12 07:16:41','2019-09-12 07:16:41'),
	(17,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:41','2019-09-12 07:16:41'),
	(18,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:43','2019-09-12 07:16:43'),
	(19,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:47','2019-09-12 07:16:47'),
	(20,1,'/admin/menu','GET','127.0.0.1','','2019-09-12 07:16:47','2019-09-12 07:16:47'),
	(21,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-12 07:16:58','2019-09-12 07:16:58'),
	(22,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-12 07:16:59','2019-09-12 07:16:59'),
	(23,1,'/admin/info/user','GET','127.0.0.1','','2019-09-12 07:17:05','2019-09-12 07:17:05'),
	(24,1,'/admin/info/authors','GET','127.0.0.1','','2019-09-12 07:17:06','2019-09-12 07:17:06'),
	(25,1,'/admin/info/posts','GET','127.0.0.1','','2019-09-12 07:17:07','2019-09-12 07:17:07'),
	(26,1,'/admin/info/user','GET','127.0.0.1','','2019-09-12 07:17:10','2019-09-12 07:17:10'),
	(27,1,'/admin/info/authors','GET','127.0.0.1','','2019-09-12 07:17:11','2019-09-12 07:17:11'),
	(28,1,'/admin/info/posts','GET','127.0.0.1','','2019-09-12 07:17:12','2019-09-12 07:17:12'),
	(29,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-19 21:38:47','2019-09-19 21:38:47'),
	(30,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-19 21:39:14','2019-09-19 21:39:14'),
	(31,1,'/admin/info/manager','GET','127.0.0.1','','2019-09-19 21:39:27','2019-09-19 21:39:27'),
	(32,1,'/admin/info/roles','GET','127.0.0.1','','2019-09-19 21:40:08','2019-09-19 21:40:08'),
	(33,1,'/admin/info/roles/edit','GET','127.0.0.1','','2019-09-19 21:40:11','2019-09-19 21:40:11'),
	(34,1,'/admin/info/permission','GET','127.0.0.1','','2019-09-19 21:40:15','2019-09-19 21:40:15'),
	(35,1,'/admin/info/permission/edit','GET','127.0.0.1','','2019-09-19 21:40:18','2019-09-19 21:40:18'),
	(36,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 21:40:21','2019-09-19 21:40:21'),
	(37,1,'/admin/info/permission','GET','127.0.0.1','','2019-09-19 21:40:29','2019-09-19 21:40:29'),
	(38,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 21:40:31','2019-09-19 21:40:31'),
	(39,1,'/admin/menu/edit/show','GET','127.0.0.1','','2019-09-19 21:40:40','2019-09-19 21:40:40'),
	(40,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 21:49:42','2019-09-19 21:49:42'),
	(41,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"header\":[\"\"],\"icon\":[\"fa-bar-chart\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\",\"2\"],\"title\":[\"E-Commerce\"],\"uri\":[\"\"]}','2019-09-19 21:50:53','2019-09-19 21:50:53'),
	(42,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"header\":[\"\"],\"icon\":[\"fa-area-chart\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\",\"2\"],\"title\":[\"E-Commerce\"],\"uri\":[\"\"]}','2019-09-19 21:53:50','2019-09-19 21:53:50'),
	(43,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 21:58:39','2019-09-19 21:58:39'),
	(44,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"header\":[\"\"],\"icon\":[\"fa-area-chart\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\",\"2\"],\"title\":[\"E-Commerce\"],\"uri\":[\"\"]}','2019-09-19 21:59:28','2019-09-19 21:59:28'),
	(45,1,'/admin/menu/new','POST','127.0.0.1','{\"_previous_\":[\"/admin/menu\"],\"_t\":[\"\"],\"header\":[\"\"],\"icon\":[\"fa-area-chart\"],\"parent_id\":[\"0\"],\"roles[]\":[\"1\",\"2\"],\"title\":[\"E-Commerce\"],\"uri\":[\"\"]}','2019-09-19 22:00:13','2019-09-19 22:00:13'),
	(46,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 22:00:17','2019-09-19 22:00:17'),
	(47,1,'/admin/menu','GET','127.0.0.1','','2019-09-19 22:00:27','2019-09-19 22:00:27');

/*!40000 ALTER TABLE `adm_operation_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table adm_permissions
# ------------------------------------------------------------
...
LOCK TABLES `adm_permissions` WRITE;
/*!40000 ALTER TABLE `adm_permissions` DISABLE KEYS */;

INSERT INTO `adm_permissions` (`id`, `name`, `slug`, `http_method`, `http_path`, `created_at`, `updated_at`)
VALUES
...
/*!40000 ALTER TABLE `adm_permissions` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table adm_role_menu
# ------------------------------------------------------------
...
LOCK TABLES `adm_role_menu` WRITE;
/*!40000 ALTER TABLE `adm_role_menu` DISABLE KEYS */;

INSERT INTO `adm_role_menu` (`role_id`, `menu_id`, `created_at`, `updated_at`)
VALUES
...
INSERT INTO `adm_session` (`id`, `sid`, `values`, `created_at`, `updated_at`)
VALUES
	(1,'0LLeWM0CzgaEbvl','{\"user_id\":1}','2019-09-12 06:46:33','2019-09-12 06:46:33'),
	(2,'CUcbob7iqzF04bz','{\"user_id\":1}','2019-09-19 21:37:44','2019-09-19 21:37:44'),
	(3,'r3AwV4AXc9ZvVKz','{\"user_id\":1}','2019-09-19 21:37:44','2019-09-19 21:37:44'),
	(4,'6zPbU3p6pN3UY3H','{\"user_id\":1}','2019-09-19 21:37:44','2019-09-19 21:37:44'),
	(5,'VuSHwx3I5idJgAa','{\"user_id\":1}','2019-09-19 21:37:45','2019-09-19 21:37:45'),
	(6,'rUaaPgBBIgdHA6i','{\"user_id\":1}','2019-09-19 21:37:47','2019-09-19 21:37:47'),
	(7,'gghv68kLhVZPa0H','{\"user_id\":1}','2019-09-19 21:37:48','2019-09-19 21:37:48'),
	(8,'Aac6QHCkr4W9VmS','{\"user_id\":1}','2019-09-19 21:37:48','2019-09-19 21:37:48'),
	(9,'xaVPOZaskBt2s2d','{\"user_id\":1}','2019-09-19 21:39:22','2019-09-19 21:39:22'),
